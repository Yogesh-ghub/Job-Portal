...
const jobsSlider = [
  {
    ...
    icon: <FaBullhorn className="h-8 w-8 -rotate-[30deg] text-mine-shaft-900" />,
  },
  {
    title: "Digital Marketing",
    description:
...
const workingPoints = [
  {
    ...
    icon: <GrDocumentText className="h-12 w-12 text-mine-shaft-900" />,
  },
  {
    title: "Apply for Job",
    desc: "Find and apply jobs that matches your skills",
    icon: <FaDisplay className="h-12 w-12 text-mine-shaft-900" />,
  },
  {
    title: "Get Hired",
    desc: "Connect with employers and start your new job",
    icon: <GrDocumentVerified className="h-12 w-12 text-mine-shaft-900" />,
  },
];
